        ...
        if (indice > 0 && indice <= playlist->tamanho) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    printf("Musica %sremovida com sucesso!\n", playlist->musicas[indice - 1].titulo);
            ...
            switch (opcao) {
                ...
                case 3: {
                    ...
                    if (indice_aleatorio != -1) {
                        printf("Musica aleatoria escolhida:\n%d. %s - %s\n", indice_aleatorio + 1, minhaPlaylist.musicas[indice_aleatorio].artista, minhaPlaylist.musicas[indice_aleatorio].titulo);
                    } else {
